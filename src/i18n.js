export const translations = {
  es: {
    ...
    whyBricksL1Alt: 'Un tiranosaurio armado con cientos de bloques pequeños: rayado en rojo y negro, panza gris, mandíbula abierta con colmillos serrados y garras',
  ...
  en: {
    ...
    whyBricksL1Alt: 'A T-rex built from hundreds of small bricks: red and black striping, grey belly, open jaw with serrated fangs, and claws',
