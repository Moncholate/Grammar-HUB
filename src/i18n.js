export const translations = {
  es: {
    ...
    whyBricksL1Alt: 'Un tiranosaurio armado con muchos bloques, con mandíbula abierta, púas y garras',
  ...
  en: {
    ...
    whyBricksL1Alt: 'A T-rex built from many bricks, with an open jaw, spikes and claws',
